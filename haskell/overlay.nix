...
lib.composeManyExtensions [
  ...
  (self: super: rec {
    haskell = super.haskell // {
        ...
        (hself: hsuper: {
          lattice-symmetries-haskell =
            doInstallForeignLibs
              ...
              (hself.callCabal2nix "lattice-symmetries-haskell" ./. { inherit (super.lattice-symmetries) kernels; });
          # .overrideAttrs
          #   (attrs: {
      ...
      # // lib.optionalAttrs (self.stdenv.isLinux && withPic && (lib.versionAtLeast hsuper.ghc.version "9.6.1")) {
